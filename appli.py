...
"""Prends le rôle d'une journaliste spécialisée sur la seconde guerre mondiale.
...
def connect_to_weaviate() -> weaviate.client.WeaviateClient:
    client = weaviate.connect_to_wcs(
        cluster_url=os.environ["https://6q45jbvsfo4cmhzrpjwoq.c1.europe-west3.gcp.weaviate.cloud/"],
        auth_credentials=weaviate.AuthApiKey(os.environ["TRroU187hKQOK5kQKdoNIBeolVyMQd8Mxjxg"]),
        headers={
            "X-OpenAI-Api-Key": os.environ["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"],
        },
    )
